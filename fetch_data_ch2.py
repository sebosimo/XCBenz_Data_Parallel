...
def get_latest_available_runs(limit=2):
    ...
    found_runs = []
    for i in range(20):  # Check last 120 hours (20 Ãƒâ€” 6h slots) to account for 3.5h pub delay
...
def main():
    ...
    # Inject lat/lon coordinates into HHL so direct profile chunks can locate grid points
        ...
        for h in range(horizon_start, horizon_end + 1):
            ...
            if has_new_data:
                ...
                if rad_scalars and sample_field is not None:
                    ...
                    # Locations without radiation: none expected

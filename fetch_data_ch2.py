...
STAC_BASE_URL = CH2_POLICY.stac_base_url
STAC_ASSETS_URL = CH2_POLICY.stac_assets_url
...
def download_static_files():
    ...
    for filename in [HHL_FILENAME, HGRID_FILENAME]:
        ...
        try:
            resp = requests.get(STAC_ASSETS_URL, timeout=CH2_POLICY.static_request_timeout_seconds)
...
def get_latest_available_runs(limit=2):
    return discover_stac_runs(policy=CH2_POLICY, limit=limit, log=log)
